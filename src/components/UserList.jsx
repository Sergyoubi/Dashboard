  ...
  return (
    <section className="w-[99%] py-3 flex justify-center items-center gap-2 hover:bg-stone-100 rounded-xl">
      <div className="w-[80%] flex justify-between gap-4">
        <p className="text-slate-500 text-base font-thin ml-2">{name}</p>
        <p className="text-slate-700 text-base font-normal relative right-4">
          {email}
        </p>
        <p className="text-slate-700 text-base font-normal relative right-[10%]">
          {address.city}
        </p>
      </div>
