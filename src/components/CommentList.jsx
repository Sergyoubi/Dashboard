...
const CommentList = ({ postId, id, name, email }) => {
  return (
    <section className="w-[99%] py-3 flex justify-center items-center gap-2 hover:bg-stone-100 rounded-xl">
      <div className="w-[80%] flex justify-between gap-4">
        <p className=" text-slate-700 text-base line-clamp-1 font-normal">
          {name}
        </p>
        <p className="text-slate-500 text-base font-thin ml-2">{email}</p>
      </div>
